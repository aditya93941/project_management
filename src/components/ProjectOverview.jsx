...
import { useNavigation, useList, useIsAuthenticated } from "@refinedev/core";
                    ...
                    <div className="divide-y divide-zinc-200 dark:divide-zinc-800">
                        {projects.slice(0, 5).map((project) => (
                            <div 
                                ...
                                onClick={() => show('projects', project.id || project._id, { tab: 'tasks' })}
                                className="block p-6 hover:bg-zinc-50 dark:hover:bg-zinc-900/50 transition-colors w-full text-left cursor-pointer"
                            >
